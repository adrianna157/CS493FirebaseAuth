...
const handlerWrapperArgs = { functionName: 'music-api-dev-getsongName', timeout: 6 };

try {
  const userHandler = require('./backend/Songlist.js');
  module.exports.handler = serverlessSDK.handler(userHandler.getsongName, handlerWrapperArgs);
} catch (error) {
