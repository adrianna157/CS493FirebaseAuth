...
const handlerWrapperArgs = { functionName: 'music-api-dev-logPost', timeout: 6 };

try {
  const userHandler = require('.//logHandler.js');
  module.exports.handler = serverlessSDK.handler(userHandler.logPost, handlerWrapperArgs);
} catch (error) {
